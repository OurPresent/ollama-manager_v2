  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6 text-zinc-800 dark:text-zinc-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <MetricCard label="Agentes Disponibles" value={6} subtext="Pipeline secuencial" accentColor="amber" />
        ...
        <MetricCard label="Privacidad / Local" value="100%" subtext="Sin fugas a la nube" accentColor="sky" />
      </div>
      ...
      <section className="bg-white/80 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800 rounded-xl p-5 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-mono text-zinc-500 dark:text-zinc-400">
          <div className="space-y-2">
            <p><span className="text-emerald-600 dark:text-emerald-400">1.</span> <span className="text-zinc-700 dark:text-zinc-300">Chat del Proyecto:</span> Consulta tu código con IA. El sistema inyecta automáticamente el contexto del proyecto (bitácoras, entidades, componentes) en cada consulta.</p>
            <p><span className="text-emerald-600 dark:text-emerald-400">2.</span> <span className="text-zinc-700 dark:text-zinc-300">Pipeline de Agentes:</span> Ejecuta flujos de trabajo automáticos: PM → Backend → Frontend → QA → DevOps. Cada agente especializado procesa el proyecto.</p>
            <p><span className="text-emerald-600 dark:text-emerald-400">3.</span> <span className="text-zinc-700 dark:text-zinc-300">Gestor Ollama:</span> Descarga, elimina y gestiona modelos LLM locales directamente desde la interfaz.</p>
          </div>
          <div className="space-y-2">
            <p><span className="text-emerald-600 dark:text-emerald-400">4.</span> <span className="text-zinc-700 dark:text-zinc-300">Playground:</span> Prueba modelos con parámetros personalizados (temperature, top_p, etc.) y compara respuestas.</p>
            <p><span className="text-emerald-600 dark:text-emerald-400">5.</span> <span className="text-zinc-700 dark:text-zinc-300">Historial:</span> Revisa todas las consultas, agentes ejecutados y cambios en el grafo de conocimiento del proyecto.</p>
            <p><span className="text-emerald-600 dark:text-emerald-400">6.</span> <span className="text-zinc-700 dark:text-zinc-300">Memoria Persistente:</span> Todos los datos se guardan en SQLite local. El grafo de conocimiento evoluciona con cada interacción.</p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">Administra y configura tus agentes especializados.</p>
          </button>
          ...
          >
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">Genera y ejecuta planes técnicos con pipeline de agentes.</p>
          </button>
          ...
          >
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">Descarga o elimina LLMs directamente desde Ollama Hub.</p>
          </button>
        </div>
      </section>
